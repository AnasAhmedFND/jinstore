...
const Details = () => {
  ...
  let singleProduct = data.filter((item) => item.id == products.id)
  ...
  return (
    <section className='container mx-auto px-2 md:flex justify-between pb-5'>
      ...
      {singleProduct.map((item, index) => (
        <div key={index} className="md:w-[48%] md:mt-0 mt-2  ">
          ...
          <div className="bg-[#FFF7ED] py-5 rounded-lg md:flex mt-4 md:items-center px-2 ">
            <p className=' text-red-500 font-bold  '>Special Offer : <span className='border px-2 rounded-md bg-[#f5e2cc]  py-2'>81</span> <span className='border px-2 rounded-md bg-[#f5e2cc]  py-2'>06</span> <span className='border px-2 rounded-md bg-[#f5e2cc]  py-2'>50  </span> <span className='px-1'>:</span> <span className='border px-2 rounded-md bg-[#f5e2cc]  py-2'>02</span>  </p>

            <p className='text-[10px] text-black font-bold md:ml-2 md:mt-0 mt-4 '>Remains until the end of the offer.</p>

          </div>


          <div className="md:flex flex flex-wrap justify-between mt-5 gap-2">
            <p className='md:px-2 px-3 py-2 border-2 rounded-md border-[#7c80a655]  flex justify-center items-center text-2xl '><span className='text-[20px] '><FaMinus /></span>  <span className='md:ml-8 ml-10'> 1</span> <span className='md:ml-8 ml-10 text-[20px] '><FaPlus /></span></p>
