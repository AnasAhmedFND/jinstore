        ...
        <section className='container mx-auto  pb-10'>
            ...
            <div className="flex flex-wrap gap-4">
                ...
                <div key={index} className="border rounded-md w-[300px]  text-center relative pt-2">
                    ...
                    <p className='absolute left-[255px] top-2 text-xl  w-[30px] h-[30px] flex justify-center items-center rounded-full bg-[#bbb8c9] '><IoHeartDislikeOutline /></p>

                    <p onClick={() => hendeleDeleteItem(index) } className='absolute left-[255px] top-14 text-xl  w-[30px] h-[30px] flex justify-center items-center rounded-full bg-[#f30ad8] text-white cursor-pointer hover:bg-red-500 hover:text-black' ><GiCrossedSabres /></p>
                    ...
                    <button className='w-full py-2 bg-black text-white font-bold rounded-sm flex justify-center items-center gap-2 ' ><GiShoppingCart className='text-xl' /> Add To Cart</button>
                </div>
