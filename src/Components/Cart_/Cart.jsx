  ...
  return (
    <section className='container mx-auto border-t '>
      ...
      <div className="flex justify-between  ">
        ...
        <div className="border-2 border-dashed w-[35%] h-[200px] rounded-md  ">
          ...
          <button className='bg-green-500 py-2 border rounded-md w-full text-white font-bold mt-[10px] '>Bay Now</button>
        </div>
